    ...
    <div className='welcome-text'>
      ...
      <div className='welcome-text-paragraph-thanks'>
        ...
        <div className='welcome-text-paragraph-thanks'>
          ...
          do. Below you can find 2 pre-planned events happening the week prior
          to our celebration which you can sign up for (find deadlines for
          signing up below each event) as well as a list of other
          recommendations of things to do and see)
        </div>
        <div className='welcome-text-paragraph'>
          Side note: This section is mainly for our out-of-town guests. If you
        ...
        <div className='welcome-text-paragraph-thanks'>
          <a
            ...
            style={{ color: 'white' }}
          >
            By big raft with music and beer
          </a>
        </div>
        <div className='welcome-text-paragraph'>
          <a
